    ...
    <>
      ...
      {/* <div className="flex flex-col items-center justify-center gap-20 py-28 text-center">
        <div className="max-w-3xl space-y-4">
          ...
          <p>
            Our e-commerce platform offers a user-friendly interface and
            powerful features to help you run your online business smoothly.
            From inventory management to secure payment processing, we've got
            you covered.
          </p>
        </div>
        <div className="space-y-12">
          <div className="flex gap-12">
            <div className="flex flex-col items-center justify-center gap-6">
              ...
              <p>
                Stay organized with our intuitive inventory management system
                that tracks your products and updates stock levels in real-time.
              </p>
            </div>
            <div className="flex flex-col items-center justify-center gap-6">
            ...
            <div className="flex flex-col items-center justify-center gap-6">
              ...
              <p>
                Create a visually stunning online store that adapts to any
                device, providing a seamless shopping experience for your
                customers.
              </p>
            </div>
          </div>
